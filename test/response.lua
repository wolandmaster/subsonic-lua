...
test.assert_equals("to xml 1", response.to_xml({}), "")

test.assert_equals("to xml 2", response.to_xml(
	{ license = { valid = true } }),
	'<license valid="true"/>')

test.assert_equals("to xml 3", response.to_xml({ musicFolders = {
...
test.assert_equals("to xml 4", response.to_xml({ indexes = {
	lastModified = 1234, { index = { name = "A",
	{ artist = { id = "1", name = "Artist" } } } } } }),
	'<indexes lastModified="1234"><index name="A">'
	.. '<artist id="1" name="Artist"/></index></indexes>')

test.assert_equals("to xml 5", response.to_xml({ indexes = {
	{ shortcut = { id = "1" } }, { shortcut = { id = "2" } },
	{ index = { name = "A" } }, { index = { name = "B" } } } }),
	'<indexes><shortcut id="1"/><shortcut id="2"/>'
	.. '<index name="A"/><index name="B"/></indexes>')

test.assert_equals("to json 1", response.to_json({}), "")

test.assert_equals("to json 2", response.to_json(
	{ license = { valid = true } }),
	'"license":{"valid":true}')

test.assert_equals("to json 3", response.to_json({ musicFolders = {
	{ musicFolder = { id = 1, name = "Music" } },
	{ musicFolder = { id = 2, name = "Video" } }
	} }), '"musicFolders":{"musicFolder":[{"id":1,"name":"Music"},'
	.. '{"id":2,"name":"Video"}]}')
...
test.assert_equals("to json 5", response.to_json({ indexes = {
	{ shortcut = { id = "1" } }, { shortcut = { id = "2" } },
	{ index = { name = "A" } }, { index = { name = "B" } } } }),
	'"indexes":{"shortcut":[{"id":"1"},{"id":"2"}],'
	.. '"index":[{"name":"A"},{"name":"B"}]}')
